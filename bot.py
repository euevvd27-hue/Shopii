...
def get_main_menu():
    buttons = [
        [colored_button(f"GATES", "gates_menu", "blue")],
        [colored_button(f"ACCOUNT", "account_menu", "purple")],
        [colored_button(f"TOOLS", "tools_menu", "orange")],
        [colored_button(f"PLANS", "plans_menu", "green")],
        [colored_button(f"CLOSE", "close_menu", "red")],
    ]
    return buttons

def get_gates_menu():
    buttons = [
        [colored_button(f"AUTH", "auth_menu", "purple")],
        [colored_button(f"CHARGE", "charge_menu", "red")],
        [colored_button(f"BACK", "back_main", "white")],
    ]
    return buttons
...
def get_auth_menu():
    buttons = [
        ...
        [colored_button(f"BACK", "gates_menu", "white")],
    ]
    return buttons
...
def get_stripe_auth_menu():
    buttons = [
        ...
        [colored_button(f"BACK", "auth_menu", "white")],
    ]
    return buttons
...
def get_shopify_menu():
    buttons = [
        ...
        [colored_button(f"BACK", "charge_menu", "white")],
    ]
    return buttons
...
def get_proxy_menu():
    buttons = [
        ...
        [colored_button(f"BACK", "tools_menu", "white")],
    ]
    return buttons
...
def get_plans_menu():
    buttons = [
        ...
        [colored_button(f"BACK", "account_menu", "white")],
    ]
    return buttons
...
async def auth_menu(event):
    message = f"""{get_live_emoji('shield')} <b>{bold_text('AUTH GATES')}</b> <b>{bold_text('~ Froxt Shopify')}</b>
...
async def braintree_menu(event):
    message = f"""{get_live_emoji('shield')} <b>{bold_text('BRAINTREE AUTH')}</b> <b>{bold_text('~ Froxt Shopify')}</b>"""
